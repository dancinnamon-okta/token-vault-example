 ...
 */
module.exports.authorizeRequest = async function(tenantConfig, headers) {
  ...
  // Validate audience
  const expectedAudience = `${process.env.PROXY_BASE_URL}/${tenantConfig.id}`
  
  if (verifiedJWT.body.aud) {
